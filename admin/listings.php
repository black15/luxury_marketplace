         ...
         <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
               <tr>
                  ...
                  <th scope="col" class="px-6 py-4">Listing</th>
                  <th scope="col" class="px-6 py-4">Client</th>
                  <th scope="col" class="px-6 py-4">Business Email</th>
            ...
            <tbody>
               <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  ...
                  <td scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                     <div class="w-16 h-16 rounded-full bg-cover" style="background-image: url('../assets/images/bugatti_mistral.jpg');"></div>
                     <div class="ps-3">
                        <div class="text-base">Bugatti Mistral 2023 Dubai Limited Edition</div>
                     </div>
                  </td>
                  <td class='px-6 py-4'>
                     Oussama Dev
                  ...
                  <td class="font-semibold px-6 py-4">
                     ...
                     <a class="text-red-500 lg:mx-2" href="#">
                        DELETE
                     </a>
                  </td>
               </tr>
